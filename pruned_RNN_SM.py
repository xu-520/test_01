...
FOLDERS = [
	{"class" : 1, "folder" : "\Pycharm Projects\G729A Speech coding\cn_g729_0_5s_FEAT"}, # The folder that contains positive data files.
	{"class" : 0, "folder" : "\Pycharm Projects\G729A Speech coding\cn_g729_20_5s_FEAT"} # The folder that contains negative data files.
]

SAMPLE_LENGTH = 500     # The sample length (ms)
...
if __name__ == '__main__':
	...
	model = Sequential()
	model.add(LSTM(50, input_length = int(SAMPLE_LENGTH / 1), input_dim = 3, return_sequences = True)) # first layer 
